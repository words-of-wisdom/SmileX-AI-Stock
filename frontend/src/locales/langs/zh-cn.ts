  ...
  page: {
    ...
    aStock: {
      ...
      limitUp: {
        ...
        lastSeal: '最后封板',
        consecutive: '连板',
        continuationProb: '连板概率',
        probHigh: '高',
        probMid: '中',
        probLow: '低',
        probFactors: '评分因子（启发式规则，非模型预测）',
        factorConsecutive: '{n} 连板',
        factorSealRatio: '封成比 {v}',
        factorBreakCountZero: '零炸板',
        factorBreakCount: '炸板 {n} 次',
        factorFirstSeal: '首封 {time}',
        factorTurnoverRate: '换手率 {v}%',
        industry: '行业',
        reason: '涨停原因',
        all: '全部',
        main: '沪深主板',
    ...
    research: {
      title: '券商研报中心',
      subtitle: '东财券商研报采集与概览，研报数据供「研报掘金」策略对个股分析',
      syncBtn: '同步研报',
      syncDone: '研报同步完成：{saved} 条入库，{failed} 只失败',
      statTotal: '近30天研报',
      statTotalSuffix: '篇',
      statStocks: '覆盖股票',
      statOrgs: '覆盖机构',
      hotStocks: '热门覆盖股票 TOP10（点击筛选）',
      hotOrgs: '高产机构 TOP10（点击筛选）',
      listTitle: '研报列表',
      stockCol: '股票',
      titleCol: '研报标题',
      orgCol: '机构',
      ratingCol: '评级',
      industryCol: '行业',
      forecastCol: '盈利预测（EPS / PE）',
      dateCol: '发布日期',
      stockPlaceholder: '6 位股票代码',

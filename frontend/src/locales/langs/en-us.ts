const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'ai_research-report': 'Research Reports',
    about: 'About',
    demo: 'Example',
  ...
  page: {
    ...
    aStock: {
      ...
      limitUp: {
        ...
        probMid: 'Mid',
        probLow: 'Low',
        probFactors: 'Scoring factors (heuristic, not a model)',
        factorConsecutive: '{n} boards',
        factorSealRatio: 'Seal ratio {v}',
        factorBreakCountZero: 'No breaks',
        factorBreakCount: '{n} breaks',
        factorFirstSeal: 'First seal {time}',
        factorTurnoverRate: 'Turnover rate {v}%',
        industry: 'Industry',
        reason: 'Reason',
        all: 'All',
        main: 'Main Board',
    ...
    aiStrategy: {
      ...
      runSubmitted: 'Submitted: LLM analysis runs in background, signals will be executed by the trade engine at market price. Check run history for results',
      stock: 'Stock',
    ...
    aiAnalysis: {
      ...
      generate: 'Generate',
      runSubmitted: 'Submitted. AI analysis is running in background, report will show when done',
      statusRunning: 'Running',
      statusSuccess: 'Success',
      statusFailed: 'Failed',
      generatingTip: 'AI is generating the analysis report based on latest market data…',
      failedTip: 'Analysis generation failed',
      emptyTip: 'No report yet. Click "Generate" at top right to start',
      historyBtn: 'History',
      historyTitle: 'Analysis History',
      backToLatest: 'Back to Latest',
      viewBtn: 'View',
      execTime: 'Generated At',
      triggerCol: 'Trigger',
      statusCol: 'Status',
      summaryCol: 'Summary',
      ...
      sector: {
        ...
        topNTip: 'Top {n} by change pct; full ranking in A-Stock / Industry Board',
    ...
    financial: {
      ...
      nextRatingLabel: 'Next Period Rating',
    ...
    research: {
      ...
      subtitle: 'Broker research reports from EastMoney, feeding the "Research Picks" strategy',
      syncBtn: 'Sync Reports',
      syncDone: 'Sync done: {saved} saved, {failed} failed',
      statTotal: 'Reports (30d)',
      statTotalSuffix: '',
      statStocks: 'Covered Stocks',
      statOrgs: 'Brokers',
      hotStocks: 'Most Covered Stocks TOP10 (click to filter)',
      hotOrgs: 'Top Brokers TOP10 (click to filter)',
      ...
      forecastCol: 'Forecast (EPS / PE)',
      dateCol: 'Published',
      stockPlaceholder: '6-digit stock code',
